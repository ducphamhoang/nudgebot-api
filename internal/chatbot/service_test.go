...
func createMockChatbotService(t *testing.T, eventBus events.EventBus, logger *zap.Logger) ChatbotService {
	...
	service, err := NewChatbotService(eventBus, logger, cfg)
...
// Additional unit tests for specific event handler methods
